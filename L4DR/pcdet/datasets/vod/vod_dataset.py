...
class VodDataset(DatasetTemplate):
    def __init__(self, dataset_cfg, class_names, training=True, root_path=None, logger=None):
        ...
        self.sim_info_path_list = [
            Path('/mnt/ssd8T/AdverseWeather/view_of_delft_PUBLIC/fog_sim_lidar/_CVL_beta_0.005/'),
            Path('/mnt/ssd8T/AdverseWeather/view_of_delft_PUBLIC/fog_sim_lidar/_CVL_beta_0.010/'),
            Path('/mnt/ssd8T/AdverseWeather/view_of_delft_PUBLIC/fog_sim_lidar/_CVL_beta_0.020/'),
            Path('/mnt/ssd8T/AdverseWeather/view_of_delft_PUBLIC/fog_sim_lidar/_CVL_beta_0.030/'),
        ]
        self.sim_info_path = Path('/mnt/ssd8T/AdverseWeather/view_of_delft_PUBLIC/fog_sim_lidar/_CVL_beta_0.100/') 
...
if __name__ == '__main__':
    ...
    if sys.argv.__len__() > 1 and sys.argv[1] == 'create_kitti_infos':
        ...
        create_kitti_infos(
            ...
            data_path= Path('/mnt/ssd8T/AdverseWeather/view_of_delft_PUBLIC/rlfusion_5f/'),
            save_path= Path('/mnt/ssd8T/AdverseWeather/view_of_delft_PUBLIC/rlfusion_5f/')
        )
