...
result_path='/home/hx/OpenPCDet-master/output/VoD_models/PP_RLF/concat_half_fog/eval/epoch_76/val/0.150/result.pkl'
#'/home/hx/OpenPCDet-master/output/VoD_models/PP_lidar/half_fog/eval/eval_all_default/0.000/epoch_71/val/result.pkl'
...
#'/home/hx/OpenPCDet-master/output/VoD_models/PP_RLF/concat_half_fog/eval/eval_all_default/default/epoch_76/val/result.pkl'
try:
...
for i in dis:
    if(i==0):
        ...
        print("0-15m:")
        result=get_official_eval_result(eval_gt_annos, eval_det_annos, class_names)
        print(result)
    elif(i==1):
        eval_det_annos = copy.deepcopy(det_pkl)
        eval_gt_annos = [copy.deepcopy(info['annos']) for info in gt_pkl]
