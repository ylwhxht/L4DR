...
class BaseBEVBackbone_MGF(nn.Module):
    ...
    def forward(self, data_dict):
        ...
        # t = np.max(lidar_x.detach().cpu().numpy(), axis=1)  
        # for k in range(t.shape[0]):
        #     t_map = t[k]
        #     if not os.path.exists('/mnt/32THHD/hx/RLF/vis/DF_lidar/'):
        #         os.makedirs('/mnt/32THHD/hx/RLF/vis/DF_lidar/')
        #     plt.imsave(f'/mnt/32THHD/hx/RLF/vis/DF_lidar/bev_feature_'+str(self.cnt)+'.png', t_map, cmap='jet')
        # t = np.max(radar_x.detach().cpu().numpy(), axis=1)  
        # for k in range(t.shape[0]):
        #     t_map = t[k]
        #     if not os.path.exists('/mnt/32THHD/hx/RLF/vis/DF_radar/'):
        #         os.makedirs('/mnt/32THHD/hx/RLF/vis/DF_radar/')
        #     plt.imsave(f'/mnt/32THHD/hx/RLF/vis/DF_radar/bev_feature_'+str(self.cnt)+'.png', t_map, cmap='jet')
        #     self.cnt+=1
...
class BaseBEVBackbone(nn.Module):
    ...
    def forward(self, data_dict):
        ...
        # for k in range(t.shape[0]):
        #     t_map = t[k]
        #     if not os.path.exists('/mnt/32THHD/hx/RLF/vis/raw_lidar/'):
        #         os.makedirs('/mnt/32THHD/hx/RLF/vis/raw_lidar/')
        #     plt.imsave(f'/mnt/32THHD/hx/RLF/vis/raw_lidar/bev_feature_'+str(self.cnt)+'.png', t_map, cmap='jet')
        # t = np.max(radar_x.detach().cpu().numpy(), axis=1)  
        # for k in range(t.shape[0]):
        #     t_map = t[k]
        #     if not os.path.exists('/mnt/32THHD/hx/RLF/vis/raw_radar/'):
        #         os.makedirs('/mnt/32THHD/hx/RLF/vis/raw_radar/')
        #     plt.imsave(f'/mnt/32THHD/hx/RLF/vis/raw_radar/bev_feature_'+str(self.cnt)+'.png', t_map, cmap='jet')
        #     self.cnt+=1
        ups = []
        ret_dict = {}
        x = spatial_features
